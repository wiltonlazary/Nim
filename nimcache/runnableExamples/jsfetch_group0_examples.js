...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557698 = false;
    F.line = 31;
    var item_33557699 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557698 = item_33557699 !== undefined;
    if (tmp_33557698) {
    F.line = 34;
    result_33557697 = nimCopy(null, makeNimstrLit(item_33557699.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557697 = nimCopy(null, (HEX24_u1__systemZdollars(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557697;
